...
const DuneBundleOptions = ({ 
  ...
  const gradientColors = {
    'dune_starter_pack': 'from-amber-500 to-orange-500',
    'dune_advanced_pack': 'from-orange-500 to-red-500',
    'dune_endgame_pack': 'from-purple-700 to-indigo-900'
  };

  const icons = {
    'dune_starter_pack': '🌅',
    'dune_advanced_pack': '🏜️',
    'dune_endgame_pack': '🌌'
  };

  return (
    <div className="space-y-5">
      <div className={`bg-gradient-to-r ${gradientColors[service.serviceType]} rounded-2xl p-4 md:p-6 text-white shadow-lg`}>
        <div className="flex items-center gap-3 mb-2">
          <span className="text-3xl md:text-4xl">{icons[service.serviceType]}</span>
...
export default DuneBundleOptions;